...
async def update_ai_insights():
    ...
    while True:
        ...
        try:
            ...
            cache_path = "/mnt/nvme/Projects/dashboard/gemini_cache.txt"
        ...
        try:
            if os.path.exists(cache_path):
                ...
                ai_insights = "🤖 Waiting for first AI generation cycle..."
        except Exception as e:
            ai_insights = f"❌ AI Read Error: {e}"

        await asyncio.sleep(10) # Check for file updates every 10 seconds
